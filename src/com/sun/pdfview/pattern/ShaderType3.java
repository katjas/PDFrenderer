...
public class ShaderType3 extends PDFShader {
	...
	class Type3PaintContext implements PaintContext {
		 ...
		 * 
		 * Given a geometric coordinate position (x, y) in or along the gradient
		 * gradient fill, the corresponding value of s can be determined by
		 * solving the quadratic constraint equation:
		 *
	...
	public void parse(PDFObject shaderObj) throws IOException {
		...
		center1 = new Point2D.Float(coords[0].getFloatValue(), coords[1].getFloatValue());
		center2 = new Point2D.Float(coords[3].getFloatValue(), coords[4].getFloatValue());
