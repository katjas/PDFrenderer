 ...
 * for an exponential function (see Section 3.9.2, "Type 2 (Exponential
 ...
 * partitioned across a domain (see Section 3.9.3, "Type 3 (Stitching)
 * Functions").</li>
 * <li>Type 4: Postscript calculations. (PDF 1.3)<br>
 * A PostScript calculator function (type 4) uses operators from the PostScript
 * language to describe an arithmetic expression (see Section 3.9.4, "Type 4
 * (PostScript Calculator) Functions").</li>
 * </ul>
 * </p>
 * 
 * <p>
