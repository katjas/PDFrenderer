...
public class OperationSet {
	...
	private void initOperations() {
		/**
		 * these operators consider the left hand arguments as deeper in the
		 * stack than the right hand arguments, thus the right-hand is is the
		 * top of the stack and is popped first.
		 *
		 * PostScriptOperation details in PostScript Language Reference Manual:
		 * http://www.adobe.com/products/postscript/pdfs/PLRM.pdf Chapter 8 -
		 * Operator Details
		 */
