...
final class Le implements PostScriptOperation {
	 ...
	 * operand is less than or equal to the second, or false otherwise. If both
	 * operands are numbers, le compares their mathematical values. If both
	 * operands are strings, le compares them element by element, treating the
	 * elements as integers in the range 0 to 255, to determine whether the
	 * first string is lexically less than or equal to the second. If the
