...
public class GoToEAction extends PDFAction {
	...
	public static class GoToETarget {
		...
		/*************************************************************************
		 * Page Number: If the value can be parsed as Integer, it specifies the
		 * page number in the current document containing the file attachment
		 * annotation. If the value is a string, it defines a named destination
		 * in the current document that provides the page number of the file
		...
		/*************************************************************************
		 * Relation between current document and the target. Can either be "P"
		 * or "C"
		 * 
		 * @return String
		 ************************************************************************/
		...
		/*************************************************************************
		 * A target dictionary specifying additional target information. If
		 * missing, the current document is the target file containing the
		 * destination.
		 * 
		 * @return GoToETarget
		 ************************************************************************/
	 ...
	 * @param targetObj
	 * @param list
	 *            - a list of all already parsed targets, for not getting in an
	 *            endless loop (if a target is found which is already contained,
	 *            the recursive calling of this method will stop).
	 * @throws IOException
	 *             - in case a value can not be parsed
	 ************************************************************************/
