...
public class LaunchAction extends PDFAction {
	...
	public static class FileSpec {
		...
		/*************************************************************************
		 * Get the filename: first try to get the file name for the used OS, if
		 * it's not available return the common file name.
		 * 
		 * @return String
		 ************************************************************************/
		...
		/*************************************************************************
		 * The name of the file system that should be used to interpret this
		 * entry.
		 * 
		 * @return String
		 ************************************************************************/
	...
	public class WinLaunchParam {
		...
		/*************************************************************************
		 * The operation to be performed (open or print). Ignored in case the
		 * "F" parameter describes a file to be opened. Default is "open".
		 * 
		 * @return String
		 ************************************************************************/
		...
		/*************************************************************************
		 * A parameter which shall be passed to the application. Ignored in case
		 * the "F" parameter describes a file to be opened.
		 * 
		 * @return String
		 ************************************************************************/
	...
	public LaunchAction(PDFObject obj) throws IOException {
		...
		// unix and mac dictionaries are not further specified, so can not be
		// parsed yet.
		this.unixParam = obj.getDictRef("Unix");
		this.macParam = obj.getDictRef("Mac");

		// check if at least the file or one of the OS specific launch
		// parameters is set:
	...
	/*************************************************************************
	 * Get the mac specific launch parameters. Note: The dictionary is not
	 * specified yet in the PDF spec., so the PdfObject which is returned here
	 * is not parsed.
	 * 
	 * @return PDFObject
	 ************************************************************************/
	...
	/*************************************************************************
	 * Get the unix specific launch parameters. Note: The dictionary is not
	 * specified yet in the PDF spec., so the PdfObject which is returned here
	 * is not parsed.
	 * 
	 * @return PDFObject
	 ...
	 * 
	 * @param fileObj
	 * @return FileSpec - might be <code>null</code> in case the passed object
	 *         is null
	 * @throws IOException
	 ...
	 * @param winDict
	 * @throws IOException
	 *             - in case of a problem during parsing content
	 ************************************************************************/
