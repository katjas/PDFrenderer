...
public class PdfObjectParseUtil {
	...
	/*************************************************************************
	 * Parse a Boolean value with the given key from parent object. If it's
	 * mandatory and not available, an exception will be thrown.
	 * 
	 * @param key
	 * @param parent
	 * @param mandatory
	 ...
	 * @throws IOException
	 ************************************************************************/
	public static PDFDestination parseDestination(String key, PDFObject parent, PDFObject root, boolean mandatory)
			throws IOException {
	...
	/*************************************************************************
	 * Parse a integer value with the given key from parent object. If it's
	 * mandatory and not available, an exception will be thrown.
	 * 
	 * @param key
	 * @param parent
	...
	/*************************************************************************
	 * Parse a String value with the given key from parent object. If it's
	 * mandatory and not available, an exception will be thrown.
	 * 
	 * @param key
	 * @param parent
