 ...
 * <p>
 * You should use the decodeStream() method of this object rather than using any
 * of the decoders directly.
 */
public class PDFDecoder {
	...
	/**
	 * Utility class for reading and storing the specification of Filters on a
	 * stream
	 */
	private static class FilterSpec {
		public PDFObject ary[];
		public PDFObject params[];
