...
public class CalGrayColor extends ColorSpace {
	...
	/**
	 * Create a new calibrated gray color space object, with the default values
	 * for black point, white point and gamma
	 */
	public CalGrayColor() {
		super(TYPE_GRAY, 1);
	}
	...
	/**
	 * Create a new Calibrated Gray color space object, given the description in
	 * a PDF dictionary.
	 * 
	 * @param obj
	 *            a dictionary that contains an Array of 3 Numbers for
	 *            "WhitePoint" and "BlackPoint", and a Number for "Gamma"
	 */
	...
	public float[] toRGB(float comp[]) {
		if (comp.length == 1) {
			...
			float xyz[] = { this.white[0] * mul, 0, 0 };
