...
public class LabColor extends ColorSpace {
	...
	private float range[] = { -100f, 100f, -100f, 100f };

	/**
	 * Create a new Lab color space object, given the description in a PDF
	 * dictionary.
	 * 
	 * @param obj
	...
	/**
	 * Stage 2 of the conversion algorithm. Pulled out because it gets invoked
	 * for each component
	 */
	...
	public float[] toRGB(float comp[]) {
		if (comp.length == 3) {
			...
			float xyz[] = { this.white[0] * stage2(l), this.white[0] * stage2(m), this.white[0] * stage2(n) };
