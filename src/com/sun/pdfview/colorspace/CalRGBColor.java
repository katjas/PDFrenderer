...
public class CalRGBColor extends ColorSpace {
	...
	private static final float[] vonKriesM = { 0.40024f, -0.22630f, 0.00000f, 0.70760f, 1.16532f, 0.00000f, -0.08081f,
			0.04570f, 0.91822f };
	private static final float[] vonKriesMinv = { 1.859936f, 0.361191f, 0.000000f, -1.129382f, 0.638812f, 0.000000f,
			0.219897f, -0.000006f, 1.089064f };
	private static final float[] xyzToSRGB = { 3.24071f, -0.969258f, 0.0556352f, -1.53726f, 1.87599f, -0.203996f,
	...
	private float matrix[] = { 1f, 0, 0, 0, 1f, 0, 0, 0, 1f };

	private float gamma[] = { 1f, 1f, 1f };

	/**
	 * Create a new Calibrated RGB color space object, given the description in
	 * a PDF dictionary.
	 * 
	 * @param obj
	 *            a dictionary that contains an array of 3 Numbers for
	 *            "WhitePoint" and "BlackPoint", a Number for "Gamma", and an
	 *            array of 9 Numbers for "Matrix".
	 */
	public CalRGBColor(PDFObject obj) throws IOException {
		...
		this.scale = new float[] { destWhite[0] / sourceWhite[0], 0, 0, 0, destWhite[1] / sourceWhite[1], 0, 0, 0,
				destWhite[2] / sourceWhite[2] };
	...
	public float[] toRGB(float comp[]) {
		if (comp.length == 3) {
			...
			float[] xyz = new float[] { this.matrix[0] * a + this.matrix[3] * b + this.matrix[6] * c,
