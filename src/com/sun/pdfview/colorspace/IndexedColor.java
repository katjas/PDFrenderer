...
public class IndexedColor extends PDFColorSpace {
	...
	/**
	 * r,g,and b components of the color table as a single array, for Java's
	 * IndexColorModel
	 */
	...
	/**
	 * create a new IndexColor PDFColorSpace based on another PDFColorSpace, a
	 * count of colors, and a stream of values. Every consecutive n bytes of the
	 * stream is interpreted as a color in the base ColorSpace, where n is the
	 * number of components in that color space.
	 *
	 * @param base
	 *            the color space in which the data is interpreted
	 * @param count
	 *            the number of colors in the table
	 * @param stream
	 *            a stream of bytes. The number of bytes must be count*n, where
	 *            n is the number of components in the base colorspace.
	 */
	 ...
	 * 
	 * @param components
	 *            an array of exactly one integer number whose value is between
	 *            0 and the size of the color table - 1.
	 */
	@Override
