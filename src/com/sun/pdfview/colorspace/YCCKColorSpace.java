...
/**
 * A ColorSpace for the YCCK color space. This color space converts to CMYK and
 * then uses an existing CMYK color space to convert from CMYK to RGB. This
 * allows embedded CMYK color profiles to be used with YCCK images. If no CMYK
 * color space is provided then by default it uses a CMYKColorSpace. Only toRGB
 * is supported.
 *
 * @author Ben Day
 */
