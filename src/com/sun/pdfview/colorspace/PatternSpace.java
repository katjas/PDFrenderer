...
/**
 * A PatternSpace fills with a pattern, the name of which is specified in the
 * call to getPaint(). This pattern is read from the resources of the current
 * page. The pattern space may also have a base color space which the pattern is
 * defined in.
 */
public class PatternSpace extends PDFColorSpace {
	...
	/**
	 * Get the paint representing a pattern, optionally with the given base
	 * paint.
	 *
	 * @param patternObj
	 *            the pattern to render
	 * @param components
	 *            the components of the base paint
	 */
