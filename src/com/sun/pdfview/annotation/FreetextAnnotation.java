...
/*****************************************************************************
 * PDF annotation describing a free text Currently only supports the XObjects
 * which can be found in the path AP->N of the annotation object (same
 * implementation as the stamp annotation)
 * 
