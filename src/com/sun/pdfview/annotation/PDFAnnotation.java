...
/*****************************************************************************
 * Encapsulate a PDF annotation. This is only the super-class of PDF
 * annotations, which has an "unknown" annotation type. Use the
 * createAnnotation() method for getting an annotation of the correct type (if
 * implemented).
 *
