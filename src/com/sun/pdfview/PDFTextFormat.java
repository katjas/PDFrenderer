...
public class PDFTextFormat implements Cloneable {
	...
	/**
	 * perform a carriage return by translating by x and y. The next carriage
	 * return will be relative to the new location.
	 */
	 ...
	 * @param ary
	 *            an array of Strings and Doubles, where the Strings represent
	 *            text to be added, and the Doubles represent kerning amounts.
	 */
	public void doText(PDFPage cmds, Object ary[], boolean autoAdjustStroke) throws PDFParseException {
		for (Object element : ary) {
			if (element instanceof String) {
				doText(cmds, (String) element, autoAdjustStroke);
			} else if (element instanceof Double) {
				float val = ((Double) element).floatValue() / 1000f;
	...
	/**
	 * set the mode of the text. The correspondence of m to mode is show in the
	 * following table. m is a value from 0-7 in binary:
	 *
	 * 000 Fill 001 Stroke 010 Fill + Stroke 011 Nothing 100 Fill + Clip 101
	 * Stroke + Clip 110 Fill + Stroke + Clip 111 Clip
	 *
	 * Therefore: Fill corresponds to the low bit being 0; Clip corresponds to
	 * the hight bit being 1; and Stroke corresponds to the middle xor low bit
	 * being 1.
	 */
	 ...
	 *
	 * @param mode
	 *            the text render mode using the codes from PDFShapeCmd and not
	 *            the wacky PDF codes
	 */
