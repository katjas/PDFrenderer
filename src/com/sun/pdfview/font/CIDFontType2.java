...
public class CIDFontType2 extends TTFFont {
	...
	/**
	 * create a new CIDFontType2 object based on the name of a built-in font and
	 * the font descriptor
	 * 
	 * @param baseName
	 *            the name of the font, from the PDF file
	 * @param fontObj
	 *            a dictionary that contains the DW (defaultWidth) and W (width)
	 *            parameters
	 * @param descriptor
	...
	/**
	 * Get the outline of a character given the character code. We interpose
	 * here in order to avoid using the CMap of the font in a CID mapped font.
	 */
	@Override
	...
	private void parseWidths(PDFObject fontObj) throws IOException {
		...
		if (widthObj != null) {
			...
			/*
			 * an entry can be in one of two forms: <startIndex> <endIndex>
			 * <value> or <startIndex> [ array of values ] we use the entryIdx
			 * to differentitate between them
			 */
