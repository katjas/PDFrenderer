...
/**
 * This class represents the 14 built-in fonts. It reads these fonts from files
 * in the "res" directory, as specified in BaseNames.properties.
 */
public class BuiltinFont extends Type1Font {
	...
	private static final String[] baseFonts = { "Courier", "Courier-Bold", "Courier-BoldOblique", "Courier-Oblique",
			"Helvetica", "Helvetica-Bold", "Helvetica-BoldOblique", "Helvetica-Oblique", "Times-Roman", "Times-Bold",
			"Times-BoldItalic", "Times-Italic", "Symbol", "ZapfDingbats" };
	/**
	 * fonts others (e.g. Acrobad PDFWriter 3.02 for Windows) assume are there,
	 * even though they're not in the spec. Grrr...
	 *
	 * the format is <Name_in_PDF> <Builtin_To_Use>
	 */
	private static final String[] mappedFonts = {
			// map arial to helvetica
			"Arial", "Helvetica", "Arial,Bold", "Helvetica-Bold", "Arial,BoldItalic", "Helvetica-BoldOblique",
			...
			"Courier,Bold", "Courier-Bold", "Courier,BoldItalic", "Courier-BoldOblique", "Courier,Italic",
			"Courier-Oblique",
			// map CourierNew to Courier
			"CourierNew", "Courier", "CourierNew,Bold", "Courier-Bold", "CourierNew,BoldItalic", "Courier-BoldOblique",
	...
	/**
	 * create a new BuiltingFont object based on a description of the font from
	 * the PDF file. Parse the description for key information and use that to
	 * generate an appropriate font.
	 */
