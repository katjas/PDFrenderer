...
public abstract class PDFFont {
	 ...
	 * object is actually a dictionary containing the following keys:<br>
	 * Type = "Font"<br>
	...
	/**
	 * Get a glyph for a given character code. The glyph is returned from the
	 * cache if available, or added to the cache if not
	 *
	 * @param src
	 *            the character code of this glyph
	 * @param name
	 *            the name of the glyph, or null if the name is unknown
	 ...
	 *
	 * The preferred method of getting the glyph should be by name. If the name
	 * is null or not valid, then the character code should be used. If the both
	 * the code and the name are invalid, the undefined glyph should be
	 * returned.
	 *
