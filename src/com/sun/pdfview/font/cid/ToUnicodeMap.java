 ...
 * This is not a fully functional CMAP parser but a stripped down parser that
 * should be able to parse some limited variants of CMAPs that are used for the
 * ToUnicode mapping found for some Type0 fonts.
 *
...
public class ToUnicodeMap extends PDFCMap {
	...
	public char map(char src) {
		...
		if (mappedChar == null) {
			// TODO XOND 27.03.2012: PDF Spec. "9.7.6.3Handling Undefined
			// Characters"
			mappedChar = 0;
		}
		return mappedChar;
