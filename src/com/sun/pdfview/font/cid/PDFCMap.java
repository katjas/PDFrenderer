...
/**
 * A CMap maps from a character in a composite font to a font/glyph number pair
 * in a CID font.
 *
 * @author jkaplan
 */
public abstract class PDFCMap {
	...
	/**
	 * Get a CMap, given a PDF object containing one of the following: a string
	 * name of a known CMap a stream containing a CMap definition
	 */
