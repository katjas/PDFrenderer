...
public class Type3Font extends PDFFont {
	...
	private HashMap<String, PDFObject> rsrc;
	/** the character processes, mapped by name */
	private Map charProcs;
	 ...
	 */
	public Type3Font(String baseFont, PDFObject fontObj, HashMap<String, PDFObject> resources,
	...
	protected PDFGlyph getGlyph(char src, String name) {
		if (name == null) {
			throw new IllegalArgumentException(
					"Glyph name required for Type3 font!" + "Source character: " + (int) src);
		}
